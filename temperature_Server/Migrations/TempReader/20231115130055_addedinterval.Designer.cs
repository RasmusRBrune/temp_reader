...
namespace temperature_Server.Migrations.TempReader
{
    ...
    [Migration("20231115130055_addedinterval")]
    partial class addedinterval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("temperature_Server.Data.TemperatureReaderDeviceKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TemperatureReaderDeviceKey");
                });
            ...
            modelBuilder.Entity("temperature_Server.Data.TemperatureReaderDeviceKey", b =>
                {
                    b.HasOne("temperature_Server.Data.TemperatureReaderDevice", "Device")
                        .WithOne()
                        .HasForeignKey("temperature_Server.Data.TemperatureReaderDeviceKey", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
